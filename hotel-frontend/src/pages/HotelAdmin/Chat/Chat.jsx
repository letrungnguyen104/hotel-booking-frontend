    ...
    const client = new Client({
      ...
      onConnect: async () => {
        ...
        client.subscribe('/topic/presence', (message) => {
          ...
          console.log('📡 Presence received:', presenceMessage);
        ...
        <div className="cl-items">
          {loadingConvos ? (
            ...
            conversations.map(convo => {
              ...
              console.log('👤 Rendering', convo.conversationPartnerUsername, '=> online?', onlineUsers.has(convo.conversationPartnerUsername));
              return (
                <div
